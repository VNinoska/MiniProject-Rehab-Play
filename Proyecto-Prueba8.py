...
##Otras canciones
#pygame.mixer.music.load("Havana (Lyrics)  Camila Cabello ft. Young Thug.mp3")
#pygame.mixer.music.load("Action - Daiki Yamashita (Normal).mp3")
#pygame.mixer.music.load("Action - Daiki Yamashita (Lenta).mp3")
